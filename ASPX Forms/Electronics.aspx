<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Electronics.aspx.cs" Inherits="ShopX.Electronics" %>
                        ...
                        <ul>
                            ...
                            <li class="Categories">
                                ...
                                <div class="dropdown-content">
                                     ...
                                     <a class="Active" href="Electronics.aspx">Electronics</a>
...
<asp:Label runat="server" ID="ProductDropDown" CssClass="list-group">
    ...
    <div class="ElectronicsHeader">
            ...
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
             ...
             <asp:DataList ID="ElectronicsProducts" runat="server"  RepeatColumns="2"
