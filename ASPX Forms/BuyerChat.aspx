<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerChat.aspx.cs" Inherits="ShopX.BuyerChat" %>
...
<asp:Label runat="server" ID="ProductDropDown" CssClass="list-group">
	...
	<aside>
		<ul>
              ...
              <%--USER LIST--%>
                <asp:DataList ID="SellerNamesLeft" runat="server"  RepeatColumns="1"
			...
			<li id="SelectedBuyer" runat="server">
				<a style="text-decoration:none; padding: 0px 5px;" runat="server" name='<%#Eval("SellerID") %>' onserverclick="ShowConversation">
                <img src="/WebImages/Avatar.jpg" width="50" alt="<%#Eval("SellerName") %>"/>
				<div >
					<h2 style="text-align:center;padding-left:5px;"><%#Eval("SellerName") %></h2>
	...
	<main>
		<header>
             ...
             <asp:DataList ID="SellerNameTop" runat="server"  RepeatColumns="1"
            RepeatDirection="Vertical">
            <ItemTemplate>
            <table>
			...
			<img src="/WebImages/Avatar.jpg" width="50" alt='<%#Eval("SellerName")%>'/>
				...
				<h2 style="float:right;text-align:center; margin-top:20px; margin-left:20px;"><%#Eval("SellerName") %></h2>
			</div>
		...
		<div id="chat">
         ...
         <footer>
			<textarea id="TypedMessage" style="font-size:20px;" runat="server" placeholder="Type your message"></textarea>
			<asp:Button ID="SendMessage" runat="server" CssClass="SendMsgBtn" Text="SEND" OnClick="SendMessage_Click" />
		</footer>
	</main>
</div>
        </asp:Label>
