<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="ShopX.AddProduct" %>
        ...
        <asp:TextBox ID="PPrice" runat="server" placeholder ="Enter Product Price"></asp:TextBox>
         ...
         <asp:RegularExpressionValidator runat="server"  Display = "Dynamic"
            ...
            <b>FOOD</b>
                ...
                <br />
        <asp:Button ID="AddProductbtn" CssClass="btn" Text="Add Product" runat="server" OnClick="AddProductbtn_Click"/>
            </div>
